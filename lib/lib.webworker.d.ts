...
type TransformerStartCallback<O> = (controller: TransformStreamDefaultController<O>) => any
...
type UnderlyingSinkStartCallback = (controller: WritableStreamDefaultController) => any
...
type UnderlyingSourceStartCallback<R> = (controller: ReadableStreamController<R>) => any
