...
function parseEventPort(eventPortStr) {
  const eventPort = eventPortStr === void 0 ? void 0 : Number.parseInt(eventPortStr)
...
function start(
  ...
  console.log = (...args2) =>
    logger.msg(args2.length === 1 ? args2[0] : args2.join(', '), typescript_exports.server.Msg.Info)
  console.warn = (...args2) =>
